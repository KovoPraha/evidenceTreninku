...
const EVIDENCE_TABLES = [
    ...
    'club_program_images',
    'club_program_offers',
    'club_program_presentations',
    'club_program_schedule_slots',
    'club_programs',
    'club_roster_events',
    'club_roster_members',
    'club_roster_structure_events',
