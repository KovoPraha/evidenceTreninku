...
try{
    ...
    $groupId=(int)$pdo->query('SELECT id FROM skupiny ORDER BY id LIMIT 1')->fetchColumn();$planId=0;$demoTrainingDate=(new DateTimeImmutable('today'))->format('Y-m-d');
