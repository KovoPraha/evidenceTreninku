...
final class ClubProgramWiringTest extends TestCase
{
    public function testPublicPagesUseSessionCsrfBeneficiaryAndActivationServices():void
    {
        ...
        self::assertStringContainsString("isset(\$_SESSION['verejny_uzivatel_id'])",$shop);self::assertStringContainsString('csrf_verify',$shop);self::assertStringContainsString('shopCartSetBeneficiary',$shop);self::assertStringContainsString('clubProgramOfferForVariant',$shop);self::assertStringContainsString('clubProgramVariantSaleState',$shop);
