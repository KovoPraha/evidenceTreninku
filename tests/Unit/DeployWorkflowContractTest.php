...
final class DeployWorkflowContractTest extends TestCase
{
    ...
    public function testBackupOwnershipIncludesCurrentMigrationTables(): void
    {
        ...
        self::assertStringContainsString(
            "EVIDENCE_OWNERSHIP_CONTRACT_VERSION = '2026-09-23.1'",
            $backup
        );
        ...
        foreach (['position_code', 'is_default', 'assigned_by_trainer_id'] as $column) {
            self::assertStringContainsString("'{$column}'", $backup);
        }
        foreach (['shop_orders', 'shop_catalog_admin_events', 'shop_attribute_definitions', 'shop_attribute_choices', 'shop_attribute_definition_events', 'shop_category_meta', 'shop_category_meta_events', 'club_events', 'club_event_links', 'club_event_people', 'club_event_planned_participants', 'club_event_vehicle_reservations', 'account_person_roles', 'fio_account_movements', 'club_roster_members', 'club_team_series', 'training_roster_links', 'club_program_enrollments', 'club_program_events', 'club_program_presentations', 'club_program_schedule_slots', 'club_program_images', 'club_event_roster_targets', 'club_roster_rollover_runs', 'public_self_profiles', 'public_velodrome_reservation_events', 'child_access_accounts', 'child_access_events', 'public_velodrome_cart_items', 'public_velodrome_order_items', 'club_event_cart_items', 'club_event_order_items', 'kis_import_source_artifacts', 'password_reset_tokens', 'club_member_charges', 'club_member_charge_events', 'kis_import_payment_rows', 'kis_import_sandbox_promotions', 'kis_import_sandbox_items', 'kis_import_sandbox_events', 'kis_import_charge_promotions', 'kis_import_charge_promotion_items', 'kis_import_charge_promotion_events', 'shop_member_category_rules', 'shop_member_product_prices', 'shop_member_price_events', 'family_calendar_feeds', 'family_calendar_feed_events', 'family_weekly_summary_preferences', 'family_weekly_summaries', 'family_weekly_summary_events', 'member_charge_reminder_preferences', 'member_charge_reminders', 'member_charge_reminder_events', 'stripe_webhook_events', 'sumup_webhook_events', 'athlete_registration_request_details', 'athlete_registration_consent_snapshots', 'athlete_private_files', 'osoba_citlive_udaje', 'osoba_citlive_pristupy'] as $table) {
    ...
    public function testContinuousIntegrationRunsDedicatedMariaDbSmokes(): void
    {
        ...
        self::assertStringContainsString('php tests/Support/StaffWorkspaceMariaDbSmoke.php', $workflow);
    }
