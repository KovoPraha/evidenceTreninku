...
final class KisImportSandboxPromotionWiringTest extends TestCase
{
    ...
    public function testServiceHasFingerprintTransactionAuditAndNoCanonicalWrites(): void
    {
        ...
        foreach (['hash_equals', 'beginTransaction', 'rollBack', 'SAVEPOINT', 'kis_import_sandbox_events', 'kisImportBuildPreviewReport', 'kisFieldContractStoredReport', 'ready_for_parity'] as $needle) {
