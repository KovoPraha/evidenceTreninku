...
final class ClubProgramWizardWiringTest extends TestCase
{
    public function testAdminWizardUsesOneTransactionalServiceAndAllDomainCores():void
    {
        ...
        self::assertStringNotContainsString('name="attributes_json"',$page);self::assertStringNotContainsString('JSON objekt',$page);self::assertStringContainsString('name="attribute_keys[]"',$page);self::assertStringContainsString('name="attribute_values[]"',$page);self::assertStringContainsString('Kroužek lze vypsat i bez nich',$page);
