...
final class FioImportWiringTest extends TestCase
{
    public function testFioImportIsCliOnlyReadOnlyAndVisibleToAdmin():void
    {
        ...
        self::assertStringNotContainsString('UPDATE payments',$service);self::assertStringNotContainsString('UPDATE shop_orders',$service);self::assertStringContainsString('eshop_fio_admin.php',(string)file_get_contents($root.'/eshop_admin.php'));
