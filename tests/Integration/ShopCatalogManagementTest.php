...
final class ShopCatalogManagementTest extends TestCase
{
    ...
    private function database():PDO
    {
        ...
        $pdo->exec('CREATE TABLE shop_product_images(id INTEGER PRIMARY KEY,product_id INTEGER,image_url TEXT,sort_order INTEGER)');$pdo->exec("INSERT INTO shop_product_images VALUES(1,1,'uploads/shop-products/aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.jpg',0)");
