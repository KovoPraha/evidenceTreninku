...
final class PasswordResetTest extends TestCase
{
    ...
    private function database(): PDO
    {
        ...
        $pdo->exec('CREATE TABLE verejni_uzivatele(id INTEGER PRIMARY KEY,email TEXT,heslo_hash TEXT,aktivni INTEGER,email_overeno INTEGER,session_version INTEGER)');
        $pdo->exec("INSERT INTO verejni_uzivatele VALUES(1,'parent@example.test','old',1,1,1),(2,'inactive@example.test','old',0,1,1)");
        ...
        $pdo->exec('CREATE TABLE treneri(id INTEGER PRIMARY KEY)');
        $pdo->exec('INSERT INTO treneri VALUES(1)');
