...
<td><?=orderAdminH($order['customer_name_snapshot'])?><div class="small"><?=orderAdminH($order['customer_email_snapshot'])?></div><?php if(($order['checkout_mode']??'account')==='guest'):?><span class="badge text-bg-light border mt-1">bez registrace</span><?php endif;?></td>
