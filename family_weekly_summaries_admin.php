...
<main class="container-fluid py-4" style="max-width:1450px">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
        <div><h1 class="h4 mb-1">Týdenní rodinné souhrny</h1><div class="small text-muted">Dobrovolný odběr, idempotentní fronta a auditované produkční odesílání.</div></div>
    ...
    <div class="alert alert-info small"><strong>Produkční zprávy odesílá plánovaný worker.</strong> Tato stránka slouží ke kontrole fronty a uloženého obsahu; ruční testovací odeslání zůstává omezené na chráněný localhostový outbox.</div>
