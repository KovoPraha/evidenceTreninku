...
<div class="container py-4" style="max-width:1280px;">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        ...
        <div class="d-flex flex-wrap gap-2"><a href="kis_rosters_admin.php" class="btn btn-outline-primary btn-sm">Týmy a soupisky</a><a href="member_charges_admin.php" class="btn btn-outline-primary btn-sm">Členské předpisy</a><a href="sync_evidence.php" class="btn btn-primary btn-sm"><i class="bi bi-upload me-1"></i>Nový import</a></div>
    </div>
