        ...
        try {
            ...
            if (auth_rate_limit_reserve_attempt($pdo, 'password_reset', $identifier, $ip)) {
                passwordResetRequest(
                    $pdo,
                    $identifier,
                    static function (string $email, string $token): bool {
...
<title>Obnova hesla — Kovopraha</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"></head>
