...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    catch(InvalidArgumentException|ShopCheckoutException|ShopCouponException $exception){$errors[]=$exception->getMessage();}
}
