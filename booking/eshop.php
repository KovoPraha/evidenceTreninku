...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    catch (InvalidArgumentException|ShopCheckoutException|ShopCouponException|ClubProgramException|PublicVelodromeShopException $exception) { $errors[] = $exception->getMessage(); }
}
