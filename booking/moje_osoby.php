...
<nav class="navbar navbar-light bg-white border-bottom shadow-sm"><div class="container">
    ...
    <div class="d-flex gap-2 flex-wrap"><a href="sportovni_prehled.php" class="btn btn-outline-primary btn-sm">Sportovní přehled</a><a href="eshop.php" class="btn btn-outline-success btn-sm">E-shop</a><a href="moje_programy.php" class="btn btn-outline-primary btn-sm">Moje kroužky</a><a href="moje_objednavky.php" class="btn btn-outline-success btn-sm">Moje objednávky</a><a href="kalendar.php" class="btn btn-outline-primary btn-sm">Kalendář</a><a href="krouzky.php" class="btn btn-outline-secondary btn-sm">Události</a><a href="moje_rezervace.php" class="btn btn-outline-secondary btn-sm">Moje rezervace</a></div>
</div></nav>
