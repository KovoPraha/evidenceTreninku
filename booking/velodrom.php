...
<main class="container py-4" style="max-width:1000px"><div class="d-flex justify-content-between mb-3"><div><h1 class="h4 mb-1">Veřejné hodiny velodromu</h1><p class="text-muted mb-0">Rozvrh a volnou kapacitu vidíte bez registrace. Účet potřebujete až pro rezervaci.</p></div><?php if($isLoggedIn):?><a class="btn btn-outline-secondary btn-sm align-self-start" href="verejny_profil.php">Můj profil</a><?php else:?><a class="btn btn-primary btn-sm align-self-start" href="prihlaseni.php?redirect=velodrom.php">Přihlásit se</a><?php endif;?></div>
